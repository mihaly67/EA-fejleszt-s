...
//|                                             For Project Merkava  |
//|                                                   Version 2.36   |
//|                    (Deep Stealth Deep Randomization)             |
//+------------------------------------------------------------------+
...
#include "../Indicators/StealthRegistry.mqh"   // Deep Stealth Registry v1.05 (Deep Random & LCG)
...
input string        InpComment           = "Merkava_v2.36"; // Fallback only
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.36");

   // --- DYNAMIC VERSION LABEL (Fixed) ---
   string version_str = "MERKAVA v2.36 (Deep Stealth)";
   ...
   Print("Merkava v2.36 Initialized (Deep Stealth Integration).");
