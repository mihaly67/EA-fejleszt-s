...
OUTPUT_FILE = "swat4_unified_data.jsonl"
OUTPUT_ZIP = "swat4_unified_knowledge.zip"
...
VALID_EXTENSIONS = {
    ...
    '.py', '.pyx', '.pxd', '.ipynb',
    # MQL5 (Expert Advisorok, Indikátorok, Scriptek)
    '.mq5', '.mqh',
    # C/C++ / CUDA (Gyorsítás, PyTorch, C++ bridge)
...
IGNORE_DIRS = {
    ...
    'Debug', 'Release', 'x64', 'x86', '.vs' # C++ / Visual Studio szemetek a Black_Ops miatt
}
...
def get_swat4_category(repo_name):
    """Besorolja a SWAT4 repókat az eredeti 4 (Black_Ops, Colombo, Thief, ML_Ops) kategória egyikébe."""
    name_lower = repo_name.lower()

    if "finrl" in name_lower or "anomaly" in name_lower or "eventstudy" in name_lower or "ml" in name_lower or "agentic" in name_lower:
        return "ML_Ops"
    elif "dxcam" in name_lower or "hellsgate" in name_lower or "injection" in name_lower or "boaz" in name_lower or "black_ops" in name_lower:
        return "Black_Ops"
    elif "thief" in name_lower or "steal" in name_lower:
        return "Thief"
    elif "colombo" in name_lower or "monitor" in name_lower or "debug" in name_lower:
        return "Colombo"
...
def process_single_file(filepath):
    ...
    category = get_swat4_category(source_repo)
...
def main():
    print("=== 🧠 SWAT4 (ML-OPS, BLACK_OPS) - STRUKTURÁLT KNOWLEDGE BUILDER ===")
