 //+------------------------------------------------------------------+
//|                                     WPR_Control_Trader_v3.03.mq5 | // VÁLTOZÁS: Verzió
//|                      Copyright 2024, Gemini & User Collaboration |
//|        Verzió: OnDeinit Cleanup (ChartIndicatorDelete)           | // VÁLTOZÁS: Leírás
//+------------------------------------------------------------------+
#property copyright "Copyright 2024, Gemini & User Collaboration"
#property link      "https://www.mql5.com"
#property version   "3.03" // VÁLTOZÁS: Verziószám
...
input string        InpEaComment              = "WPR_Control_v3.03"; // VÁLTOZÁS: Komment
...
void CreatePanel()
  {
   ...
   ObjectSetString(0, panel_title_name, OBJPROP_TEXT, "WPR Control Trader v3.03"); // VÁLTOZÁS: Verzió
...
int OnInit()
  {
   ...
   Print("WPR Control Trader v3.03 Initialized. (Cleanup Fix - Indi Delete)"); // VÁLTOZÁS: Üzenet
...
void OnDeinit(const int reason) // VÁLTOZÁS: Takarítás ChartIndicatorDelete-tel
  {
   ...
   // VÁLTOZÁS: Indikátorok törlése a chartról név alapján, ha az EA-t eltávolítják
   if(reason == REASON_REMOVE)
     {
      ...
      // Az ablaknak automatikusan be kell záródnia, ha üres
     }
