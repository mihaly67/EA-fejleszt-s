...
# Kikapcsoljuk a hardveres gyorsítást (GPU), hogy a QWebEngineView
# tisztán szoftveres renderelést (Software Rasterizer) használjon.
# Ezeket a QApplication PÉLDÁNYOSÍTÁSA ELŐTT kell beállítani!
# ---------------------------------------------------------
os.environ["QTWEBENGINE_DISABLE_GPU"] = "1"
os.environ["QTWEBENGINE_CHROMIUM_FLAGS"] = "--disable-gpu --disable-software-rasterizer"

# További kompatibilitási flagek headless/xrdp környezethez:
...
# ---------------------------------------------------------
# IMPORT KÖZBEN IS BIZTOSÍTJUK A FLAGS ÉRVÉNYESÜLÉSÉT
...
class ZMQReceiverThread(QThread):
    ...
    def run(self):
        ...
        # Kis várakozás, hogy a GUI és a Chromium JS felépüljön
        self.msleep(2000)
...
class AdvancedHUD(QMainWindow):
    def __init__(self):
        ...
        # Opcionális RDP fix a webview háttér átlátszóságára
        ...
        # ZMQ indítás késleltetve a UI felépülése után
