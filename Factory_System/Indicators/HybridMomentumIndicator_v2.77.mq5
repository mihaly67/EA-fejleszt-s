//+------------------------------------------------------------------+
//|                                HybridMomentumIndicator_v2.77.mq5 |
//|                     Copyright 2026, Jules Agent & User           |
//|        Verzió: 2.77 (FIX: Repainting & Deterministic Calc)       |
//+------------------------------------------------------------------+
...
/*
   ===================================================================
   HYBRID MOMENTUM INDICATOR v2.77 - VÉGLEGES JAVÍTÁSOK
   ===================================================================
   Ez a verzió javítja a "Repainting" (átrajzolás) hibát, ami miatt
   a múltbeli görbe megváltozott idősík-váltáskor.

   JAVÍTÁSOK (v2.77):
   1. DETERMINISZTIKUS SZÁMÍTÁS: A v2.76-ban a Standard Dev szórás
      számítása olyan buffer-értékre hivatkozott (az aktuális gyertyánál),
      ami még nem volt beállítva. Ez "memória-szemetet" vagy előző futásból
      maradt adatot használt, ami instabillá tette a görbét.
      A v2.77-ben a puffer értéke a számítás ELŐTT kerül beállításra.
   2. STOCHASTIC BOOS: A Boost logika most már a helyes, előre beállított
      RAW MACD értéket normalizálja.
*/
...
int OnInit()
{
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "Hybrid Momentum v2.77");
