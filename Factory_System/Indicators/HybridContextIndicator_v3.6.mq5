//+------------------------------------------------------------------+
//|                                     HybridContextIndicator_v3.6.mq5 |
//|                     Copyright 2024, Gemini & User Collaboration |
//|      Verzió: 3.6 (Cascading Reference & Buffer Visualization)     |
//+------------------------------------------------------------------+
...
int OnInit()
{
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "Hybrid Context v3.6");
...
void OnDeinit(const int reason)
{
   ...
   // Objects are gone in v3.6, but delete just in case upgrading from v3.4 on same chart
