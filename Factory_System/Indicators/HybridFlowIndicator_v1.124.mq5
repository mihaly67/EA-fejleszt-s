//+------------------------------------------------------------------+
//|                                     HybridFlowIndicator_v1.124.mq5 |
//|                     Copyright 2024, Gemini & User Collaboration |
//|      Verzió: 1.124 (FIX: Group Removal for EA Integration)       |
//+------------------------------------------------------------------+
...
/*
   ===================================================================
   HYBRID FLOW INDICATOR - v1.124
   ===================================================================
   A v1.124-es verzió eltávolítja az `input group` direktívákat
   az `Mimic_Trap_Research_EA` stabilitása érdekében.

   A v1.123 funkciói (Histogram Decoupling) változatlanok maradnak.
*/
...
int OnInit()
{
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "Hybrid Flow v1.124");
