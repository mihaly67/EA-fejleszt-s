//+------------------------------------------------------------------+
//|                                   Mimic_Trap_Research_EA_v2.08.mq5|
//|                                                      Jules Agent |
//|                       Focused Strategy: Liquidity Mimicry Trap   |
//|                       Mode: RESEARCH & DATA MINING (v2.08)       |
//+------------------------------------------------------------------+
...
int OnInit()
  {
   ...
   if(g_log_handle != INVALID_HANDLE)
     {
      // Updated Header
      string header = "Time,TickMS,Phase,MimicMode,TargetTP,Bid,Ask,Spread,Velocity,Acceleration,Mom_Hist,Mom_Macd,Mom_Sig,Flow_MFI,Flow_DUp,Flow_DDown,Ext_VA_Vel,Ext_VA_Acc,Micro_Press,Micro_Color,Floating_PL,Realized_PL,Session_PL,Action,PosCount,ActiveSL,ActiveTP,DOM_Snapshot\r\n";
   ...
   Print("Mimic Trap Research EA v2.08 (Dev) Initialized.");
...
void WriteLog()
  {
   ...
   // CSV Row
   // Header: Time,TickMS,Phase,MimicMode,TargetTP,Bid,Ask,Spread,Velocity,Acceleration,Mom_Hist,Mom_Macd,Mom_Sig,Flow_MFI,Flow_DUp,Flow_DDown,Ext_VA_Vel,Ext_VA_Acc,Micro_Press,Micro_Color,Floating_PL,Realized_PL,Session_PL,Action,PosCount,ActiveSL,ActiveTP,DOM_Snapshot
   string row = StringFormat("%s,%s,%s,%d,%.2f,%.5f,%.5f,%.1f,%.5f,%.5f,%.5f,%.5f,%.5f,%.2f,%.2f,%.2f,%.5f,%.5f,%.2f,%.1f,%.2f,%.2f,%.2f,%s,%d,%.5f,%.5f",
