...
- **Daemon Szakaszos Ellenőrzése:** Az Agent I/O timeout elkerülésére a `agent_keepalive.py` daemonnak futnia kell. Hosszú sessionök alatt szakaszosan, manuálisan ellenőrizd (`pgrep -af agent_keepalive`), és indítsd újra, ha leállt.
