...
MODEL_PATH = "models/lgbm_model_3MTF_v2_asym.pkl" # A modell marad a régi, csak a küszöbök változnak!
PARAMS_PATH = "models/optuna_regime_params_3MTF_v3.json"
OUTPUT_HTML = "data/regime_volatile_decision_chart.html"
LIMIT_BARS = 600
...
def main():
    ...
    fig = make_subplots(
        ...
        subplot_titles=("Price & Regime ML Signals", "Model Probabilities & Dynamic Thresholds", "Macro Trend (M15_RSI_14)")
    )
    ...
    # 3. Trend Indicator
    fig.add_trace(go.Scatter(x=df['Start_Timestamp'], y=df['M15_RSI_14'], mode='lines', line=dict(color='cyan', width=2), name='M15_RSI'), row=3, col=1)
    ...
    fig.update_layout(
        title="Dynamic Regime-Switching Thresholds Evaluation",
