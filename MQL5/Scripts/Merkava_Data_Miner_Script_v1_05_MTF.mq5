//+------------------------------------------------------------------+
//|                             Merkava_Data_Miner_Script_v1_05_MTF.mq5 |
//|                                                      Jules Agent |
...
void OnStart()
{
    ...
    for(int i=0; i<count; i++)
    {
        ...
        // -------------------------------------------------------------
        // MTF ARCHITECTURE: Leakage-Free Extraction
        // Extrapolating the LAST CLOSED higher timeframe data!
        // This ensures the M1 model cannot 'see' the future of M5/M15
        // -------------------------------------------------------------
        double ema50_m5 = 0; double rsi_m5 = 0; double macd_m5 = 0;
        double ema150_m15 = 0; double rsi_m15 = 0;
        ...
        // Write to CSV
        // Direct MTF CSV Writing (Bypassing BlackBox headers to include new MTF columns)
        string csv_line = StringFormat("%s,%I64d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f",
            TimeToString(rates[i].time, TIME_DATE|TIME_SECONDS), time_msc, bid, ask, spread, r_open, r_high, r_low, r_close, rsi, velocity, acceleration, macd, pulse, mfi, roc, delta, ema25, ema50, ema150, ema300, wpr, stoch, ping_ms, ema50_m5, ema150_m15, rsi_m5, rsi_m15, macd_m5);
        FileWrite(m_file_handle, csv_line);
    }
