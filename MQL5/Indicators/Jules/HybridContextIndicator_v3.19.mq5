//+------------------------------------------------------------------+
//|                                    HybridContextIndicator_v3.19.mq5 |
//|                     Copyright 2024, Gemini & User Collaboration |
//|      Verzió: 3.19 (Visualization Fix: Empty Value & Buffer Types) |
//+------------------------------------------------------------------+
...
int OnInit()
{
   ...
   PlotIndexSetDouble(0, PLOT_EMPTY_VALUE, EMPTY_VALUE); // FIX: Ensure proper masking
   ...
   PlotIndexSetDouble(1, PLOT_EMPTY_VALUE, EMPTY_VALUE); // FIX
   ...
   PlotIndexSetDouble(2, PLOT_EMPTY_VALUE, EMPTY_VALUE); // FIX
   ...
   PlotIndexSetDouble(3, PLOT_EMPTY_VALUE, EMPTY_VALUE); // FIX
   ...
   PlotIndexSetDouble(4, PLOT_EMPTY_VALUE, EMPTY_VALUE); // FIX
   ...
   PlotIndexSetDouble(5, PLOT_EMPTY_VALUE, EMPTY_VALUE); // FIX
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "Hybrid Context v3.19");
   ...
   if(InpShowPivots)
   {
      ...
      for(int i = start; i < rates_total; i++)
      {
         ...
         if(InpUseMicro) {
             ...
             MicroR1[i] = EMPTY_VALUE; MicroS1[i] = EMPTY_VALUE; MicroP[i] = EMPTY_VALUE; // FIX
         }
         ...
         if(InpUseSecondary) {
             ...
             SecR1[i] = EMPTY_VALUE; SecS1[i] = EMPTY_VALUE; SecP[i] = EMPTY_VALUE; // FIX
         }
         ...
         if(InpUseTertiary) {
             ...
             TerR1[i] = EMPTY_VALUE; TerS1[i] = EMPTY_VALUE; TerP[i] = EMPTY_VALUE; // FIX
         }
      }
   }
