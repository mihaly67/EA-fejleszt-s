...
//|                                             For Project Merkava  |
//|                                                   Version 2.36   |
//|                    (Deep Stealth Custom PRNG & Encoding Fix)     |
//+------------------------------------------------------------------+
...
#include "../Indicators/StealthRegistry.mqh"   // Deep Stealth Registry v1.05 (Custom PRNG)
...
int OnInit()
{
   ...
   if(DeepStealth_Enabled) {
       m_registry.Init();
       reg_ptr = &m_registry;
       Print("🕵️ Deep Stealth Registry ACTIVATED. Random Magic Numbers Enabled.");
   }
