...
// Library Organization (v2.03)
#include "../Indicators/FireControl.mqh"
#include "../Indicators/PhysicsEngine.mqh"
#include "../Indicators/NavSystem_v2_03.mqh" // v2.03: DF Fix + Cold Start
#include "../Indicators/BlackBox_v2_03.mqh" // v2.03: 5 Decimal Precision
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.03"); // Log Version Updated
   ...
   Print("Merkava v2.03 Initialized (Precision Mode 5-Dec).");
...
void CreatePanel() {
   ...
   ObjectSetString(0, ObjStat, OBJPROP_TEXT, "MERKAVA v2.03");
