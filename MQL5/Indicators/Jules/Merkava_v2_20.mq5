...
//|                                             For Project Merkava  |
//|                                                   Version 2.20   |
//|                    (Production Candidate: Momentum + Full Panel)   |
//+------------------------------------------------------------------+
...
#include "../Indicators/FireControl_v2_20.mqh" // Updated
#include "../Indicators/PanelControl_v2_20.mqh" // Updated
#include "../Indicators/PhysicsEngine.mqh"
#include "../Indicators/NavSystem_v2_11.mqh" // HybridMomentum v2.82
#include "../Indicators/BlackBox_v2_08.mqh" // HybridMomentum Logging
...
input string        InpComment           = "Merkava_v2.20";
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.20");
   ...
   Print("Merkava v2.20 Initialized (HybridMomentum v2.82 + Full Panel Control).");
...
void OnTick()
{
   ...
   m_black_box.RecordTick(
       tick.time_msc, g_last_action, 0, "TEST_MOMENTUM",
