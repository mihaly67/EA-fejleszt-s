...
// Library Organization (v2.04)
#include "../Indicators/FireControl.mqh"
#include "../Indicators/PhysicsEngine.mqh"
#include "../Indicators/NavSystem_v2_04.mqh" // v2.04: DF Double Precision Fix
#include "../Indicators/BlackBox_v2_04.mqh" // v2.04: Bumped
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.04");
   ...
   Print("Merkava v2.04 Initialized (Float Fix).");
...
void CreatePanel() {
   ...
   ObjectSetString(0, ObjStat, OBJPROP_TEXT, "MERKAVA v2.04");
