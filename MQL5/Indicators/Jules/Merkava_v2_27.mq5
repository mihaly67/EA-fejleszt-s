...
//|                                             For Project Merkava  |
//|                                                   Version 2.27   |
//|               (HybridContext v3.25 Reorder Fix + Momentum)         |
//+------------------------------------------------------------------+
...
#include "../Indicators/NavSystem_v2_18.mqh" // Context v3.25 Reorder Support
...
// [Hybrid Context Settings v3.25 - Refined Buffer Order]
input string        InpContextPath       = "Jules\\HybridContextIndicator_v3.25_Reorder";
...
// Forced OFF usually, but exposed
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.27");
   ...
   Print("Merkava v2.27 Initialized (Context v3.25 Reorder + Momentum v2.82).");
