...
//|                                             For Project Merkava  |
//|                                                   Version 2.28   |
//|               (HybridContext v3.26 Flat Inputs + Reordered Buffers)|
//+------------------------------------------------------------------+
...
#include "../Indicators/NavSystem_v2_19.mqh" // Context v3.26 Flat Support
...
// [Hybrid Context Settings v3.26 - FLAT STRUCTURE - NO GROUPS]
input string        InpContextPath       = "Jules\\HybridContextIndicator_v3.26_Flat";
...
int OnInit()
{
   ...
   // Prepare Context Params (v3.26 Flat Structure)
   ContextParams ctx;
   ...
   m_black_box.Initialize(_Symbol, "v2.28");
   ...
   Print("Merkava v2.28 Initialized (Context v3.26 Flat/Reordered + Momentum v2.82).");
