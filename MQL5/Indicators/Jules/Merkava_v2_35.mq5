...
#include "../Indicators/StealthRegistry.mqh"   // Deep Stealth Registry v1.04 (Deep Random)
...
input string        InpComment           = "Merkava_v2.35"; // Fallback only
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.35");

   // --- DYNAMIC VERSION LABEL (Fixed) ---
   string version_str = "MERKAVA v2.35 (Deep Stealth)";
   ...
   Print("Merkava v2.35 Initialized (Deep Stealth Integration).");
