...
#include "../Indicators/FireControl_v2_22.mqh" // Deep Stealth v2.22
...
int OnInit()
{
   ...
   string version_str = "MERKAVA v2.37 (Deep Stealth Fix)";
   ...
   Print("Merkava v2.37 Initialized (CSV Log Fix).");
