...
//|                                             For Project Merkava  |
//|                                                   Version 2.21   |
//|               (HybridContext v3.18 + HybridMomentum v2.82 Dual)  |
//+------------------------------------------------------------------+
...
#include "../Indicators/NavSystem_v2_12.mqh" // Full Integration
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.21");
   ...
   Print("Merkava v2.21 Initialized (HybridContext v3.18 + HybridMomentum v2.82).");
