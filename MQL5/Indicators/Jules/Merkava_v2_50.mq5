...
int OnInit()
{
   ...
   Print("=== Merkava v2.50 (Mirror Phase) Startup ===");
   ...
   m_black_box.Initialize(_Symbol, "v2.50");

   string version_str = "MERKAVA v2.50 (Mirror Phase)";
   ...
   Print("Merkava v2.50 Initialized.");
