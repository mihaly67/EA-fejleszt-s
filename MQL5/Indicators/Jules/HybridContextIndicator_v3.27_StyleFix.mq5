//+------------------------------------------------------------------+
//|                        HybridContextIndicator_v3.27_StyleFix.mq5 |
//|                     Copyright 2024, Gemini & User Collaboration |
//|      Verzió: 3.27 (Style Fix: Micro=Dot, Flat Inputs, Reordered)  |
...
int OnInit()
{
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "Hybrid Context v3.27 (Style Fix)");
