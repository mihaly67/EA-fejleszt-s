...
//|                                             For Project Merkava  |
//|                                                   Version 2.34   |
//|                    (Deep Stealth Humanized Magic Numbers)        |
//+------------------------------------------------------------------+
...
#include "../Indicators/StealthRegistry.mqh"   // Deep Stealth Registry v1.03 (Humanized)
...
input string        InpComment           = "Merkava_v2.34"; // Fallback only
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.34");

   // --- DYNAMIC VERSION LABEL (Fixed) ---
   string version_str = "MERKAVA v2.34 (Deep Stealth)";
   ...
   Print("Merkava v2.34 Initialized (Deep Stealth Integration).");
