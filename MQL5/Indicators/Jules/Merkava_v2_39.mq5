...
//|                                             For Project Merkava  |
//|                                                   Version 2.39   |
//|                    (Deep Stealth: Strict Comment Sanitization)   |
//+------------------------------------------------------------------+
...
#include "../Indicators/FireControl_v2_24.mqh" // Deep Stealth v2.24 (Strict Comments)
...
input string        InpComment           = ""; // DEFAULT EMPTY (Strict Stealth)
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.39");

   // --- DYNAMIC VERSION LABEL (Fixed) ---
   string version_str = "MERKAVA v2.39 (Strict Stealth)";
   ...
   Print("Merkava v2.39 Initialized (Strict Stealth).");
