...
//|                                             For Project Merkava  |
//|                                                   Version 2.32   |
//|                    (Deep Stealth Registry Integration)           |
//+------------------------------------------------------------------+
...
#include "../Indicators/StealthRegistry.mqh"   // Deep Stealth Registry v1.0
...
input string        InpComment           = "Merkava_v2.32"; // Fallback only
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.32");

   // --- DYNAMIC VERSION LABEL (Fixed) ---
   string version_str = "MERKAVA v2.32 (Deep Stealth)";
   ...
   Print("Merkava v2.32 Initialized (Deep Stealth Integration).");
