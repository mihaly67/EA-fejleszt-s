...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.02"); // Log Version Updated
   ...
   Print("Merkava v2.02 Initialized (Precision Mode).");
...
void CreatePanel() {
   ...
   ObjectSetString(0, ObjStat, OBJPROP_TEXT, "MERKAVA v2.02");
