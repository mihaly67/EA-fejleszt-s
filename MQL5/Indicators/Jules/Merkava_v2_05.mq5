...
// Library Organization (v2.05)
#include "../Indicators/FireControl.mqh"
#include "../Indicators/PhysicsEngine.mqh"
#include "../Indicators/NavSystem_v2_05.mqh" // v2.05: CopyBuffer for Hybrid
#include "../Indicators/BlackBox_v2_05.mqh" // v2.05: Bumped
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.05");
   ...
   Print("Merkava v2.05 Initialized (Hybrid CopyBuffer Mode).");
...
void CreatePanel() {
   ...
   ObjectSetString(0, ObjStat, OBJPROP_TEXT, "MERKAVA v2.05");
