//+------------------------------------------------------------------+
//|                                    HybridContextIndicator_v3.20.mq5 |
//|                     Copyright 2024, Gemini & User Collaboration |
//|      Verzió: 3.20 (No Input Groups + Linear Buffers Fix)          |
//+------------------------------------------------------------------+
...
input bool               InpShowTrends         = true; // Show Trends
input int                InpMaxHistoryBars     = 50000;
input bool               InpShowFibo           = false; // Show Fibo
input int                InpFiboMicroHistory   = 0;

input bool               InpUseMicro           = true; // Micro On/Off
...
input bool               InpUseSecondary       = true; // Sec On/Off
...
input bool               InpUseTertiary        = true; // Ter On/Off
...
int OnInit()
{
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "Hybrid Context v3.20");
