...
// Library Organization (v2.09)
#include "../Indicators/FireControl_v2_09.mqh" // v2.09: Synced with User Machine Logic
...
input double        InpMinSpreadPoints   = 60.0; // v2.09: Included for adaptive potential (passed as min_dist)
...
input ulong         InpMagicNumber       = 999009; // Updated Magic
input string        InpComment           = "Merkava_v2.09";
...
int OnInit()
{
   ...
   // v2.09: Initialize FireControl with pointers (User version logic)
   ...
   m_black_box.Initialize(_Symbol, "v2.09"); // Update Log Version
   ...
   Print("Merkava v2.09 Initialized (Synced with User FireControl).");
...
void OnChartEvent(const int id, const long &lparam, const double &dparam, const string &sparam)
{
   if(id == CHARTEVENT_OBJECT_CLICK)
   {
      if(sparam == ObjBtnFire)
      {
         ...
         // v2.09: Pass InpMinSpreadPoints as min_dist_points
...
void CreatePanel() {
   ...
   ObjectSetString(0, ObjStat, OBJPROP_TEXT, "MERKAVA v2.09");
