...
//|                                             For Project Merkava  |
//|                                                   Version 2.25   |
//|               (HybridContext v3.22 Clone of v3.18 Logic)         |
//+------------------------------------------------------------------+
...
#include "../Indicators/NavSystem_v2_16.mqh" // Context v3.22 Support
...
// [Hybrid Context Settings v3.22 - LINEAR INPUTS, v3.18 Logic]
input string        InpContextPath       = "Jules\\HybridContextIndicator_v3.22";
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.25");
   ...
   Print("Merkava v2.25 Initialized (Context v3.22 + Momentum v2.82).");
