...
//|                                             For Project Merkava  |
//|                                                   Version 2.33   |
//|                    (Deep Stealth Registry Integration Fix)       |
//+------------------------------------------------------------------+
...
#include "../Indicators/StealthRegistry.mqh"   // Deep Stealth Registry v1.02
...
input string        InpComment           = "Merkava_v2.33"; // Fallback only
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.33");

   // --- DYNAMIC VERSION LABEL (Fixed) ---
   string version_str = "MERKAVA v2.33 (Deep Stealth)";
   ...
   Print("Merkava v2.33 Initialized (Deep Stealth Integration).");
