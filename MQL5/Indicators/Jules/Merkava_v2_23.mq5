...
//|                                             For Project Merkava  |
//|                                                   Version 2.23   |
//|               (HybridContext v3.20 + Buffer Alignment Fix)       |
//+------------------------------------------------------------------+
...
#include "../Indicators/NavSystem_v2_14.mqh" // Context v3.20 Support
...
// [Hybrid Context Settings v3.20 - LINEAR INPUTS]
input string        InpContextPath       = "Jules\\HybridContextIndicator_v3.20";
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.23");
   ...
   Print("Merkava v2.23 Initialized (Context v3.20 + Momentum v2.82).");
