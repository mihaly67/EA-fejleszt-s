...
//|                                             For Project Merkava  |
//|                                                   Version 2.38   |
//|                    (Deep Stealth Deep Randomization & CSV Log Fix)|
//+------------------------------------------------------------------+
...
#include "../Indicators/FireControl_v2_23.mqh" // Deep Stealth v2.23 (Log Fix)
...
input string        InpComment           = "Merkava_v2.38"; // Fallback only
...
int OnInit()
{
   ...
   if(DeepStealth_Enabled) {
       ...
       m_registry.LogAudit("INIT_TEST", 0, 0, "Merkava v2.38 Started");
   }
   ...
   m_black_box.Initialize(_Symbol, "v2.38");

   // --- DYNAMIC VERSION LABEL (Fixed) ---
   string version_str = "MERKAVA v2.38 (Deep Stealth Fix)";
   ...
   Print("Merkava v2.38 Initialized (CSV Log Fix).");
