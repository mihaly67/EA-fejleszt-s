//+------------------------------------------------------------------+
//|                              HybridContextIndicator_v3.26_Flat.mq5 |
//|                     Copyright 2024, Gemini & User Collaboration |
//|      Verzió: 3.26 (Buffer Reordered + NO INPUT GROUPS)            |
//|      Logic: All DATA buffers (0-7) first, CALC buffers (8-10) last|
//|             Styles: Micro/Ter=Solid, Sec=DashDot                  |
//+------------------------------------------------------------------+
...
int OnInit()
{
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "Hybrid Context v3.26 (Flat+Reordered)");
