...
//|                                             For Project Merkava  |
//|                                                   Version 2.17   |
//|                    (HybridContextIndicator v3.18 Integration)      |
//+------------------------------------------------------------------+
...
// Library Organization (v2.17)
#include "../Indicators/FireControl_v2_16.mqh"
#include "../Indicators/PanelControl_v2_16.mqh"
#include "../Indicators/PhysicsEngine.mqh"
#include "../Indicators/NavSystem_v2_09.mqh" // Updated
#include "../Indicators/BlackBox_v2_07.mqh" // Updated
...
input string        InpComment           = "Merkava_v2.17";
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.17"); // Update Log Version
   ...
   Print("Merkava v2.17 Initialized (Context Integr. + CSV Expansion).");
