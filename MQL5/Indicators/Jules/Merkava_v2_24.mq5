...
//|                                             For Project Merkava  |
//|                                                   Version 2.24   |
//|               (HybridContext v3.21 Clone of v3.18 + Group Fix)   |
//+------------------------------------------------------------------+
...
#include "../Indicators/NavSystem_v2_15.mqh" // Context v3.21 Support
...
// [Hybrid Context Settings v3.21 - LINEAR INPUTS, v3.18 Logic]
input string        InpContextPath       = "Jules\\HybridContextIndicator_v3.21";
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.24");
   ...
   Print("Merkava v2.24 Initialized (Context v3.21 + Momentum v2.82).");
