...
//|                                             For Project Merkava  |
//|                                                   Version 2.22   |
//|               (HybridContext v3.19 Vis Fix + Momentum Retention) |
//+------------------------------------------------------------------+
...
#include "../Indicators/NavSystem_v2_13.mqh" // Context v3.19 Support
...
// [Hybrid Context Settings v3.19]
input string        InpContextPath       = "Jules\\HybridContextIndicator_v3.19";
...
int OnInit()
{
   ...
   m_black_box.Initialize(_Symbol, "v2.22");
   ...
   Print("Merkava v2.22 Initialized (Context v3.19 + Momentum v2.82).");
