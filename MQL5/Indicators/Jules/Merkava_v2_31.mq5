...
//|                                             For Project Merkava  |
//|                                                   Version 2.31   |
//|               (Stealth Engine + Dynamic Panel + Style Fix + Mom) |
//+------------------------------------------------------------------+
...
#include "../Indicators/FireControl_v2_21.mqh" // Stealth Integrated v2.21
...
int OnInit()
{
   ...
   // --- PASS STEALTH TO FIRE CONTROL ---
   m_fire_control.Init(&m_trade, &m_symbol, InpComment, InpMagicNumber, &m_stealth);
   ...
   m_black_box.Initialize(_Symbol, "v2.31");

   // --- DYNAMIC VERSION LABEL (Fixed) ---
   string version_str = "MERKAVA v2.31";
   ...
   Print("Merkava v2.31 Initialized (Stealth Engine + Dynamic Panel).");
