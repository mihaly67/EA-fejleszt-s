...
public:
   CBlackBox()
   {
      ...
      m_headers = "Time,TickMSC,Phase,MimicMode,Verdict,Bid,Ask,Spread,BidVol,AskVol," +
                  ...
                  "Mic_P,Mic_R,Mic_S,Sec_P,Sec_R,Sec_S,Ter_P,Ter_R,Ter_S," + // Context v3.28 Pivots
   ...
   void RecordTick(
      ...
      // Context Inputs (13 Fields: 9 Pivots + 4 EMAs)
   ...
   )
   {
      ...
      string row = StringFormat(
         ...
         "%.5f,%.5f," +
         "%.3f,%.3f,%.3f," +
         "%.5f,%.5f,%.5f,%.5f,%.5f,%.5f,%.5f,%.5f,%.5f," + // Context Pivots
