...
//+------------------------------------------------------------------+
//| Forensic Recorder - CSV Logging (v2.07)                          |
...
public:
   CBlackBox()
   {
      ...
      m_is_active = false;
      // v2.07 Unified Headers (Includes 11 Context Fields)
      // Mic_P, Mic_R, Mic_S, Sec_P, Sec_R, Sec_S, Ter_P, Ter_R, Ter_S, Trend_Fast, Trend_Slow
   ...
   bool Initialize(string symbol, string version)
   {
      ...
      m_is_active = true;
      Print("BlackBox v2.07 Recording to: ", m_filename);
      return true;
   }
