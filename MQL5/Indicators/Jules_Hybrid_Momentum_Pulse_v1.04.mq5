//+------------------------------------------------------------------+
//|                         Jules_Hybrid_Momentum_Pulse_v1.04.mq5    |
//|                                     Jules Agent & User           |
//|                 Hybrid Momentum Pulse (Native Zero Level)        |
//+------------------------------------------------------------------+
...
int OnInit()
  {
   ...
   {
       Print("Hybrid Pulse v1.04: Failed to create handles!");
       return INIT_FAILED;
   }
   ...
   // Removed BufferZero (Plot 3) - Handled by Levels
   ...
   // 3. Properties
   IndicatorSetString(INDICATOR_SHORTNAME, "Jules_Hybrid_Momentum_Pulse_v1.04");
   IndicatorSetInteger(INDICATOR_DIGITS, Digits());

   // Shift DF (Plot 2 is Index 2 in Data buffers? No.
   // PLOT INDICES:
   // Plot 0 (Index 0 in Plots) = MACD Hist (Buffers 0,1)
   // Plot 1 (Index 1 in Plots) = DF Curve (Buffer 2)
   // So we shift Plot 1.
