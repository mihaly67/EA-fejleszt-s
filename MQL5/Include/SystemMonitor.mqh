...
public:
   ...
   bool Radar_CheckMemoryScanners() {
      ...
      if(snapshot != -1) {
         ...
         Print("[RADAR] WARNING: Toolhelp32Snapshot API is available. Memory enumeration possible.");
   ...
   bool Radar_CheckNetworkTelemetry() {
      ...
      if(simulated_packet_size > 800) {
         PrintFormat("[RADAR] WARNING: Large Telemetry Packet Detected! Size: %d bytes. Potential Behavioral Data Transmission.", simulated_packet_size);
