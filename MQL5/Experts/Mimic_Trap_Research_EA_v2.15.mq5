//+------------------------------------------------------------------+
//|                                   Mimic_Trap_Research_EA_v2.15.mq5|
//|                                                      Jules Agent |
//|                       Focused Strategy: Liquidity Mimicry Trap   |
//|                       Mode: RESEARCH & DATA MINING (v2.15 FINAL) |
//+------------------------------------------------------------------+
...
input int                Flow_InpMFIPeriod           = 5;      // [Flow] MFI Period
input bool               Flow_InpShowVROC            = true;    // [Flow] Show VROC?
input int                Flow_InpVROCPeriod          = 5;      // [Flow] VROC Period
...
void OnTick()
  {
   ...
   g_transaction_buffer = ""; // Clear transactions
  }
...
void CreatePanel()
  {
   ...
   ObjectSetString(0, ObjStat, OBJPROP_TEXT, "READY v2.15");
   curr_y += 20;
