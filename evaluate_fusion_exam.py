...
def main():
    print("=== 🎓 FUSION LGBM OUT-OF-SAMPLE EXAM ===")
    ...
    # Due to Dollar Bar data sync limitations, the last full date available in the fused set is 2026-07-16
    ...
    print("Training Fusion LGBM on Historical Data...")
    ...
    fig.update_layout(
        title=f"LGBM Feature Fusion Copilot (Exam Day: {target_date}) | Micro DOM + Macro ZigZag",
        yaxis_title="Price", yaxis2_title="Probability",
        xaxis_rangeslider_visible=False, template="plotly_dark", height=1000
    )

    html_path = "../data/lgbm_fusion_exam_July16.html"
