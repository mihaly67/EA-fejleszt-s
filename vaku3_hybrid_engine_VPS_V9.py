...
class VakuHybridEngine:
    def __init__(self, macro_timeframe_min=5, hmm_risk_threshold=30.0, macro_er_threshold=0.15):
...
def main():
    ...
    engine = VakuHybridEngine(macro_timeframe_min=5, hmm_risk_threshold=20.0, macro_er_threshold=0.15)
