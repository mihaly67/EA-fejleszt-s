...
ENVIRONMENT_RESOURCES = {
    ...
    # --- ÚJ SWAT3 RAG (FAISS + SQLITE) ---
    "SWAT3_RAG": {
        "id": "1-t8kjijjg7cf4gXp9_z8GffGq_fTa_Uk",
...
def main():
    print(f"{Fore.CYAN}=== 🚀 RESTORE ENV SWAT3 (FAISS + SQLITE RAG DEPLOYMENT) ==={Style.RESET_ALL}")
    ...
    # 4. Végső Üzenet
    print(f"\n{Fore.GREEN}✅ SWAT3 KÖRNYEZET KÉSZ. RAG RENDSZER (FAISS) AKTÍV. (HMM/Encoders Ready){Style.RESET_ALL}")
