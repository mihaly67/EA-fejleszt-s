...
def install_dependencies():
    ...
    required = [
        "gdown",
        # "sentence-transformers", # Removed due to user hardware constraints
        # "faiss-cpu",             # Removed due to user hardware constraints
        "numpy",
        "pandas",
        "colorama"
    ]
...
ENVIRONMENT_RESOURCES = {
    ...
    # --- TC4 PHASE 3 BŐVÍTÉSEK (KÉMELHÁRÍTÁS & BLACK OPS) ---
    "MI6_LIBRARY": {
        "id": "1y2aJpzMbKkDDcPNxQhA7Eb48qW6SwXJm",
        "file": "knowledge_base_MI6.zip",
        "extract_to": "Knowledge_Base/MI6",
        "check_file": None # Dynamic check first
    },
    "BLACK_OPS_LIBRARY": {
        "id": "1MNAoH_rDitIX9Yr5oHpXPhcaG1w2Vbtg",
        "file": "knowledge_base_Black_Ops.zip",
        "extract_to": "Knowledge_Base/Black_Ops",
        "check_file": None # Dynamic check first
    }
}
...
def main():
    print(f"{Fore.CYAN}=== 🚀 RESTORE ENV TC 4 (PHASE 3: COUNTER-INTELLIGENCE) ==={Style.RESET_ALL}")
