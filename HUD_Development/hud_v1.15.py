...
class BasicHUD(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Jules HUD - v1.15 (Static Subchart + Line Thresholds)")
        ...
        # 4D Optuna Aszimmetrikus Küszöbök (Statikus vonal sorozatként, hogy mindenképp megjelenjenek)
        self.thresh_long_line = self.subchart.create_line(color='rgba(0, 255, 0, 0.5)', width=1)
        self.thresh_short_line = self.subchart.create_line(color='rgba(255, 0, 0, 0.5)', width=1)
    ...
    def on_data_received(self, data):
        ...
        try:
            if not self.is_initialized:
                ...
                # Statikus Optuna szintek kirajzolása vonalként az adott időpillanatban
                ...
                # Statikus Optuna szintek vonalainak hosszabbítása minden ticknél
