...
class BasicHUD(QMainWindow):
    def __init__(self):
        ...
        self.res_sec = self.chart.horizontal_line(0.0001, color='rgba(255, 0, 0, 0.7)', width=2, style='dashed', text='Res Sec')
        self.sup_sec = self.chart.horizontal_line(0.0001, color='rgba(0, 255, 0, 0.7)', width=2, style='dashed', text='Sup Sec')
        self.res_ter = self.chart.horizontal_line(0.0001, color='rgba(255, 0, 0, 0.9)', width=2, style='solid', text='Res Ter')
        self.sup_ter = self.chart.horizontal_line(0.0001, color='rgba(0, 255, 0, 0.9)', width=2, style='solid', text='Sup Ter')
