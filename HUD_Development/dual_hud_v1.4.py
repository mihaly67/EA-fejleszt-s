...
class DualPaneHUD(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("LGBM Copilot - Dual Pane HUD")
        ...
        self.bid_line = self.chart.create_line('Bid', color='royalblue', width=1, style='dotted', price_line=True, price_label=True)
        self.ask_line = self.chart.create_line('Ask', color='orange', width=1, style='dotted', price_line=True, price_label=True)
        self.last_line = self.chart.create_line('Last', color='white', width=1, style='dashed', price_line=True, price_label=True)
