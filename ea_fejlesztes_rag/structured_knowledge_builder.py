...
OUTPUT_FILE = "ea_fejlesztes_data.jsonl"
OUTPUT_ZIP = "ea_fejlesztes_knowledge.zip"
...
def process_single_file(filepath):
    ...
    try:
        ...
        # Ha a fájl útközben törlődött, jogosultsági hiba van, vagy hibás symlink
        return None
    except Exception:
        return None
...
def main():
    print("=== 🧠 EA FEJLESZTÉS & ML-OPS - STRUKTURÁLT KNOWLEDGE BUILDER ===")
