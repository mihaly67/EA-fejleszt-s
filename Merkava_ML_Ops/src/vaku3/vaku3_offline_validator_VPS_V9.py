...
class Vaku3OfflineValidator:
    ...
    def __init__(self, window_size=15):
        ...
        # A HMM modell (covariance_type="full" a Singluar Matrix elkerülésére!)
        ...
        self.state_map = {"Quiet": 0, "Concrete": 1, "Theater": 2, "Aggressive_Trend": 3} # Csak placeholder, a fit után felülírjuk
    ...
    def extract_features(self, df):
        ...
        for i in range(len(df)):
            ...
            if i >= self.window_size:
                ...
                # Bővített Observation Space: [Log-ER, Spread Elasticity, Z-Tick Density, Velocity, MACD]
